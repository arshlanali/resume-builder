...
const testimonials = [
    {
        ...
        avatar:
            'https://avatars.githubusercontent.com/arshlanali',
    }
];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://avatars.githubusercontent.com/arshlanali" />
                <meta property="og:url" content="https://craft-my-cv.vercel.app/" />
